...
void system_t::load_memory()
{
    ...
    ifstream in("/home/esp2022/sz2949/testbench/channel_01_float_XS/input_tensor.bin", ios::in | ios::binary);
    ...
    in.open("/home/esp2022/sz2949/testbench/channel_01_float_XS/conv_filters.bin", ios::in | ios::binary);
    ...
    in.open("/home/esp2022/sz2949/testbench/channel_01_float_XS/output_tensor.bin", ios::in | ios::binary);
    in.read((char *) sw_output, out_size * sizeof(float));
    fprintf(stderr, "size = %d\n", in.gcount()/4);
...
int system_t::validate()
{
    ...
    errors = _validate(hw_output, sw_output, batch_size, num_filters/2, output_pool_h, output_pool_w);
    ...
    // delete [] out;
    // delete [] gold;
    // fprintf(stderr, "%d, %d, %d", in_size, weights_size, out_size);
    for (int i=0; i<10; i++){
        std::cout<<hw_output[i]<<" "<<sw_output[i]<<std::endl;
    }
