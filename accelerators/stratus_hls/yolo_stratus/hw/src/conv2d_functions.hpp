    ...
    uint16_t *loadable_chan_sz, uint16_t *chan_rem_sz)
{
    ...
    *max_cacheable_rows_init = *max_cacheable_rows;
    ...
    uint16_t cacheable_outputs = OUTPUT_PLM_SIZE / ((uint16_t) *output_w *
						    *max_cacheable_rows);
    fprintf(stderr, "OUTPUT_PLM_SIZE = %d\n", OUTPUT_PLM_SIZE);
    fprintf(stderr, "output_w = %d\n", *output_w);
    fprintf(stderr, "max_cacheable_rows = %d\n", *max_cacheable_rows);
    uint16_t cacheable_filters = WEIGHTS_PLM_SIZE / (*filter_size);
    fprintf(stderr, "---- debug 01, x = %d\n", 0);
    fprintf(stderr, "cacheable_filters = %d\n", cacheable_filters);
    fprintf(stderr, "n_filters = %d\n", n_filters);
    fprintf(stderr, "cacheable_outputs = %d\n", cacheable_outputs);
    fprintf(stderr, "BIAS_PLM_SIZE = %d\n", BIAS_PLM_SIZE);
    ...
    *max_cacheable_filters_size = *filter_size * *max_cacheable_filters;
    fprintf(stderr, "max_cacheable_filters = %d\n", *max_cacheable_filters);
