...
// void init_tensor(float* tensor, const int size, const std::string& fileName) {

//     fprintf(stderr, "start init\n");
//     ifstream in(fileName, ios::in | ios::binary);
//     in.read((char *) &tensor, sizeof tensor);
//     fprintf(stderr, "fileName = %s, size = %d\n", fileName, in.gcount()/4);
// }
